...
## Unreleased — Native Windows integration
...
See [Windows changes](docs/windows-changelog.md), [English guide](docs/windows.md), and [简体中文说明](docs/windows.zh-CN.md) for support boundaries and manual acceptance. This entry does not create a release tag or claim signing, live-account verification, hardware acceptance, ten-language Windows localization or full historical pricing parity.
